...
from basic_flask.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, DeletePostForm, RequestResetForm, ResetPasswordForm
from basic_flask import app, db, bcrypt, mail
...
def send_reset_email(user):
    ...
    msg = Message("Password Reset Request", sender="abdevsup@gmail.com", recipients=[user.email])
